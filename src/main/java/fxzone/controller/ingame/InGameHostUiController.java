...
public class InGameHostUiController extends InGameNetworkUiController implements ServerHostController {
    ...
    protected void onPlayerCreatesUnit(UnitSerializable unitSerializable, int statPurchasingPrice, boolean inTransport){
        super.onPlayerCreatesUnit(unitSerializable, statPurchasingPrice, inTransport);
        server.sendPacketToAllVerifiedPlayers(new UnitCreatedPacket(unitSerializable, statPurchasingPrice, inTransport));
    }
